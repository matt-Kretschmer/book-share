...
VALUES ('9780452284234', 3, 0),
('9780007491568', 2, 0),
('9780451526342', 1, 0);
GO

INSERT INTO bookReview([bookID], [userID], [rating], [description])
VALUES ('9780452284234', 3, 5, 'Great Book'),
('9780007491568', 2, 1, 'Not recommended, it is not great'),
('9780451526342', 1, 3, 'Totally average honestly');
GO

INSERT INTO copyConditionRating([copyID], [rating], [ratingDate])
VALUES (3, 5, GETDATE()),
